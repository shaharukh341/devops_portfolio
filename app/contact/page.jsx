            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Input
                  ...
                  required
                  className= "bg-black text-white placeholder-gray-400 dark:bg-white dark:text-black dark:placeholder-gray-600"
                />
              </div>
              {/* textarea */}
              <Textarea
                className="h-[200px] bg-black text-white placeholder-gray-400 dark:bg-white dark:text-black dark:placeholder-gray-600"
                name="message"
